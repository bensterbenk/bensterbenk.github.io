var makeItRain = function () {
    ...
    while (increment < 100) {
      ...
      drops +=
        ...
        randoHundo +
        's;"></div>' +
        '<img class="svg" src="10685265_calla_lily_blossom_spring_flower_icon.svg" alt="heart" style="fill: ' +
        randomColor +
        ';">' +
        '</div>';
      ...
      backDrops +=
        ...
        randoHundo +
        's;"></div>' +
        '<img class="svg" src="10685265_calla_lily_blossom_spring_flower_icon.svg" style="fill: ' +
        randomColor +
        ';">' +
        '</div>';
    }
